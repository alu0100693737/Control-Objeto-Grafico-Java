...
public class PanelBolaAssert extends AbstractAssert<PanelBolaAssert, PanelBola> {
  ...
  public PanelBolaAssert hasDiffXInicio(int diffXInicio) {
    ...
    String errorMessage = format("\nExpected <%s> diffXInicio to be:\n  <%s>\n but was:\n  <%s>", actual, diffXInicio, actual.getDiffXInicio());
    
    // check
    if (actual.getDiffXInicio() != diffXInicio) { throw new AssertionError(errorMessage); }
  ...
  public PanelBolaAssert hasDiffYInicio(int diffYInicio) {
    ...
    // we overrides the default error message with a more explicit one
    String errorMessage = format("\nExpected <%s> diffYInicio to be:\n  <%s>\n but was:\n  <%s>", actual, diffYInicio, actual.getDiffYInicio());
    
    // check
    if (actual.getDiffYInicio() != diffYInicio) { throw new AssertionError(errorMessage); }
  ...
  /**
   * Verifies that the actual PanelBola's posInicioX is equal to the given one.
   * @param posInicioX the given posInicioX to compare the actual PanelBola's posInicioX to.
   * @return this assertion object.
   * @throws AssertionError - if the actual PanelBola's posInicioX is not equal to the given one.
   */
  public PanelBolaAssert hasPosInicioX(int posInicioX) {
    // check that actual PanelBola we want to make assertions on is not null.
    isNotNull();

    // we overrides the default error message with a more explicit one
    String errorMessage = format("\nExpected <%s> posInicioX to be:\n  <%s>\n but was:\n  <%s>", actual, posInicioX, actual.getPosInicioX());
    
    // check
    if (actual.getPosInicioX() != posInicioX) { throw new AssertionError(errorMessage); }
  ...
  /**
   * Verifies that the actual PanelBola's posInicioY is equal to the given one.
   * @param posInicioY the given posInicioY to compare the actual PanelBola's posInicioY to.
   * @return this assertion object.
   * @throws AssertionError - if the actual PanelBola's posInicioY is not equal to the given one.
   */
  public PanelBolaAssert hasPosInicioY(int posInicioY) {
    // check that actual PanelBola we want to make assertions on is not null.
    isNotNull();

    // we overrides the default error message with a more explicit one
    String errorMessage = format("\nExpected <%s> posInicioY to be:\n  <%s>\n but was:\n  <%s>", actual, posInicioY, actual.getPosInicioY());
    
    // check
    if (actual.getPosInicioY() != posInicioY) { throw new AssertionError(errorMessage); }
  ...
  public PanelBolaAssert hasVelocidad(int velocidad) {
    ...
    // we overrides the default error message with a more explicit one
    String errorMessage = format("\nExpected <%s> velocidad to be:\n  <%s>\n but was:\n  <%s>", actual, velocidad, actual.getVelocidad());
    
    // check
    if (actual.getVelocidad() != velocidad) { throw new AssertionError(errorMessage); }
